...
<head>
    ...
    <title>Campus Safety Presentation</title>
...
<body class="preso-body">

    <div id="preso-container" style="display: flex; flex-direction: column; width: 100%; max-width: 64rem; max-height: 95vh; background-color: white; border-radius: 1rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); overflow: hidden; margin: 2rem auto;">
        
        <div id="preso-slides-wrapper" style="flex-grow: 1; min-height: 0; overflow-y: auto; display: flex; align-items: center; justify-content: center; padding: 1rem 2rem;">
            ...
            <div class="preso-slide">
                <div class="w-full text-left">
                    <h2 class="text-2xl md:text-3xl font-bold text-blue-900 mb-4 text-center">The Core Safety Challenge (2021-2023)</h2>
                    <p class="text-gray-700 mb-4 text-lg text-center">An analysis of Clery Act crime statistics shows Trenton State's primary safety issues are not random violence, but internal and interpersonal offenses.</p>
                    ...
                    <div class="grid md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <ol class="list-decimal list-inside space-y-2 text-gray-800">
                                <li>Community Resource Officer</li>
                                <li>Mobile Safety App</li>
            ...
            <div class="preso-slide">
                 <div class="w-full text-left">
                    ...
                    <ul class="text-xs text-gray-700 space-y-3">
                        <li>Benson, E. (2025, April 2). How mobile-integrated security technology is changing campus safety. *Campus Safety Magazine*.</li>
                        <li>California Community Colleges Chancellor's Office. (2022). *A call to action: The California community colleges' task force report on reimagining campus policing*.</li>
                        <li>The College of New Jersey. (2024). *The College's annual security and fire safety report 2024*. Campus Police Services.</li>
                        <li>Goodall, K., & Brodie, R. (2024). Foundations of empathy and resilience: Integrating trauma-informed policing from recruit training onward. *Journal of Community Safety and Well-Being, 9*(1).</li>
                        <li>University of Bridgeport. (2025, February 20). *How colleges are enhancing campus safety measures in 2025*.</li>
                    </ul>
                </div>
            </div>
